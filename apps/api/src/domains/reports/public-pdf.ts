...
function drawRuns(surface: Surface, runs: InlineRun[], opts: DrawRunsOpts): number {
...
function drawRichBlocks(surface: Surface, blocks: RichBlock[], opts: DrawBlocksOpts): number {
  let y = opts.y;
