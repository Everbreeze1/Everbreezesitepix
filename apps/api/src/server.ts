...
app.post("/v1/hooks/workflow-automation", (c) => handleWorkflowAutomation(c.req.raw));
app.post("/v1/hooks/workflow-escalation", (c) => handleWorkflowEscalation(c.req.raw));
...
app.post("/api/public/hooks/workflow-automation", (c) => handleWorkflowAutomation(c.req.raw));
app.post("/api/public/hooks/workflow-escalation", (c) => handleWorkflowEscalation(c.req.raw));
