    ...
    <PortfolioChrome site={site} isHome={false}>
        ...
        <section className="border-t border-neutral-100 bg-neutral-50">
          <div className="mx-auto max-w-6xl px-6 py-16 lg:px-10 lg:py-20">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <h2 className="font-portfolio-display text-balance text-3xl font-semibold tracking-tight lg:text-5xl">
      ...
      {(site.phone || site.email || site.cta_url) && (
        <section id="contact" className="scroll-mt-24" style={{ backgroundColor: accent }}>
          ...
          >
            <h2 className="font-portfolio-display text-balance text-4xl font-semibold leading-tight tracking-tight lg:text-6xl">
