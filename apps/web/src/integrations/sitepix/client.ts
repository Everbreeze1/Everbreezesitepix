// SitePix Supabase client. Set VITE_SUPABASE_URL / VITE_SUPABASE_PUBLISHABLE_KEY
...
export const SITEPIX_SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL as string | undefined;
// Publishable key — safe to ship in client code (RLS applies).
export const SITEPIX_SUPABASE_PUBLISHABLE_KEY = import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY as
  | string
  | undefined;
...
function createSupabaseClient() {
  ...
  return createClient<Database>(SITEPIX_SUPABASE_URL, SITEPIX_SUPABASE_PUBLISHABLE_KEY, {
    auth: {
