...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#1e5aa6" },
      ...
      { property: "og:image", content: "https://everbreezesitepix.com/icon-512.png" },
      { name: "twitter:image", content: "https://everbreezesitepix.com/icon-512.png" },
    ],
    links: [
