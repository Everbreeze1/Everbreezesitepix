...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://everbreezesitepix.com/" },
    ...
    links: [{ rel: "canonical", href: "https://everbreezesitepix.com/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://everbreezesitepix.com/",
          logo: "https://everbreezesitepix.com/icon-512.png",
          description:
