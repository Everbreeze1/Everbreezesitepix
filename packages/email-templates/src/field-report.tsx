  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your report <strong>{subject}</strong> has been generated and is
        ...
        <Text style={muted}>
          This secure download link will expire in {expiresInDays} days. Save
          the file locally if you need long-term access.
        </Text>
        <Hr style={hr} />
        <Text style={footer}>
          Sent by {siteName}. If you didn't request this report, you can safely
          ignore this email.
        </Text>
      </Container>
    </Body>
